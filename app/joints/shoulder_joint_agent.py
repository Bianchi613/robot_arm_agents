class ShoulderJointAgent:
    ...
    def propose(self, intention: dict, state: dict) -> dict:
        ...
        return {
            ...
            "speed": 0.35,
            "reason": "Adjust the main height to reach the destination rank.",
            "llm_used": False,
        }
    ...
    def _qwen_propose(self, agent_name: str, joint: str, intention: dict, state: dict, limits: dict) -> dict | None:
        ...
        return {
            ...
            "reason": proposal.get("reason", "Proposal generated by Qwen."),
    ...
    def _require_or_fallback(self, proposal: dict | None) -> dict | None:
        if proposal or self.fallback_enabled:
            return proposal
        raise RuntimeError("Qwen/Ollama did not answer and fallback is disabled.")
